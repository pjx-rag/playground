...
config :playground, PlaygroundWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "rFus8V2GpeXJj9bXjD5ggzhJWUO9yWkZqvZOuuX1+y0RegJNUvritq6KNCQSLOqn",
  watchers: [
...
config :playground, PlaygroundWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/playground_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
...
# Tigris Object Storage for development
# Set these env vars or use `source .env` before starting the server
config :ex_aws,
...
config :playground, :storage,
  bucket: System.get_env("TIGRIS_BUCKET_NAME") || "playground-dev",
  region: "auto"

config :playground, :environment, :dev
